...
// // Header Component
// export function Header({ onSearch, searchQuery = "", resultCount = 0 }) {
...
//               {/* Results indicator */}
//               <div className="flex items-center space-x-2 bg-white/15 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/30">
//                 <TrendingUp className="text-green-300 w-5 h-5" />
//                 <span className="text-white font-medium">
//                   {searchQuery ? `${resultCount} Results` : "Live Search"}
//                 </span>
//               </div>
//             </div>
...
//               {/* Mobile results */}
//               <div className="flex items-center justify-center space-x-2 bg-white/15 backdrop-blur-sm rounded-lg py-2 border border-white/30">
//                 <TrendingUp className="text-green-300 w-5 h-5" />
//                 <span className="text-white font-medium">
//                   {searchQuery
...
import { useState } from "react";
import { Menu, X, Search, TrendingUp, Play, Pause } from "lucide-react";
...
export default function App() {
  ...
  const [resultCount] = useState(42); // Mock result count
  ...
  const handleSearch = (query) => {
    ...
    if (liveSearchEnabled) {
      // Simulate live search behavior
      console.log("Live searching for:", query);
      // Here you would typically make an API call or filter results
    }
  };

  const handleLiveSearchToggle = (isActive) => {
    setLiveSearchEnabled(isActive);
    console.log("Live search is now:", isActive ? "ON" : "OFF");

    // If live search is activated and there's a query, perform search
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="bg-white rounded-lg p-6 shadow-lg">
          <h2 className="text-2xl font-bold mb-4">Search Status</h2>
          <div className="space-y-2">
            ...
            <p>
              ...
              {liveSearchEnabled ? "✅ Active" : "❌ Inactive"}
            </p>
            <p>
              <strong>Result Count:</strong> {searchQuery ? resultCount : 0}
            </p>
          </div>
        </div>
      </div>
